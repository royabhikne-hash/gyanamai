    ...
    try {
      ...
      const checkPageBreak = (requiredSpace: number) => {
        if (yPos + requiredSpace > pageHeight - 25) {
          ...
          pdf.text("Gyanam AI - Student Progress Report", margin, 10);
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        pdf.setFontSize(8);
        pdf.setFont("helvetica", "normal");
        pdf.text("Generated by Gyanam AI | Your AI Study Partner", pageWidth / 2, pageHeight - 7, { align: "center" });
